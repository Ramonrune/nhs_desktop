 ...
 */
public class DiseaseUpdateWindow extends JDialog implements ViewConfigurable {
    ...
    private String id, idDisease, idPatient, anotation;
    public void setPatientDisease(String idDisease, String idPatient, String id, String anotation){
        ...
        DiseaseModel diseaseModel = list.stream().filter(e-> e.getIdDisease().equals(idDisease)).collect(Collectors.toList()).get(0);
        diseaseComboBox.setSelectedItem(diseaseModel);
        diseaseComboBox.setEnabled(false);
        
        descriptionTextField.setText(anotation);
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("DiseaseUpdateWindow.title")); // NOI18N

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel1.setText(bundle.getString("DiseaseUpdateWindow.jLabel1.text")); // NOI18N

        jLabel2.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel2.setText(bundle.getString("DiseaseUpdateWindow.jLabel2.text")); // NOI18N
        ...
        addDiseaseButton.setText(bundle.getString("DiseaseUpdateWindow.addDiseaseButton.text")); // NOI18N
    ...
    private void addDiseaseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addDiseaseButtonActionPerformed
        ...
        boolean ok = patientDAO.updateBindDisease(id,descriptionTextField.getText());
        if(ok){
            
            setVisible(false);
            patientPanel.chargeDiseases();
            JOptionPane.showMessageDialog(null, i18nPatient.getString("DiseaseUpdateWindow.update"));
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiseaseUpdateWindow.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DiseaseUpdateWindow().setVisible(true);
            }
        });
    }
